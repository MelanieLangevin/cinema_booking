...
$this->Html->script('View/Studios/edit', array('inline' => false));
?>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if ($this->Session->check('Auth.User')) { ?>				
                            <li class="list-group-item"><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Movie.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Movie.id'))); ?></li>
                        <?php } ?>				
