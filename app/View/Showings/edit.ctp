<div id="page-container" class="row">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if ($this->Session->check('Auth.User')) { ?>
                            <li class="list-group-item"><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Showing.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Showing.id'))); ?></li>
                        <?php } ?> 				
                        <li class="list-group-item"><?php echo $this->Html->link(__('List Showings'), array('action' => 'index')); ?></li>
                    </ul></div>
                <div class="dropdown">
    ...
    <div id="page-content" class="col-sm-9">
        ...
        <h2><?php echo __('Edit Showing'); ?></h2>
...
<?php
echo($this->Js->get('#ShowingRatingId')->event('change', $this->Js->request(array(
            'controller' => '../movies',
            'action' => 'getByRating'
                ), array(
