<nav class="navbar navbar-default" role="navigation">
    <div class="navbar-header">
        ...
        ?>
               <?php echo 
$this->Html->link('<svg width="75" height="75" id="SVG-Circus-47720dea-0a34-9e2c-01b6-abb8198857ae" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid meet">
